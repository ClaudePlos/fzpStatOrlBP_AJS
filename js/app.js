...
config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/FZPimport', {templateUrl: 'partials/FZPimport.html', controller: 'FzpOrlen'});
    ...
    $routeProvider.when('/hello', {templateUrl: 'partials/hello.html', controller: 'ApplicationCtrl'});
